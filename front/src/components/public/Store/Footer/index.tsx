    ...
    return (
      <footer className="space-pt--100 space-pb--100 bg-color--grey">
        <div className="container">
          <div className="row">
            <div className="space-mb-mobile-only--50 col-lg-9 col-md-12">
              <nav className="footer-nav-container footer-nav-container--horizontal space-mb--20">
                <ul>
                  ...
                  <li>
                    <a href="/contacto">Ubicacion de la tienda</a>
                  </li>
                  <li>
            ...
            <div className="text-left text-lg-right col-lg-3 col-md-12">
