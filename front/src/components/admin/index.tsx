...
const Index = () => {
    ...
    const salir = () => {
      ...
      return(
        ...
        {view ? <> <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            ...
            <div className="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li className="breadcrumb-item text-sm text-dark active" aria-current="page"><button onClick={() => setNav()}>Quitar xd</button></li>
